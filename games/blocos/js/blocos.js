// Motor de jogo adaptado de javascript-tetris por Jake Gordon (MIT).
// https://github.com/jakesgordon/javascript-tetris
// A lógica das peças, rotação, colisão e remoção de linhas mantém-se igual
// ao original; a interface foi reestilizada para o tema escuro do JogaZone.
...
//-------------------------------------------------------------------------
// piece shapes (each rotation encoded as a 16 bit grid)
//-------------------------------------------------------------------------

var i = { size: 4, blocks: [0x0F00, 0x2222, 0x00F0, 0x4444], color: '#5da9ff' };
var j = { size: 3, blocks: [0x44C0, 0x8E00, 0x6440, 0x0E20], color: '#7ee8b5' };
var l = { size: 3, blocks: [0x4460, 0x0E80, 0xC440, 0x2E00], color: '#ffd166' };
var o = { size: 2, blocks: [0xCC00, 0xCC00, 0xCC00, 0xCC00], color: '#ffe08a' };
var s = { size: 3, blocks: [0x06C0, 0x8C40, 0x6C00, 0x4620], color: '#c58bff' };
var t = { size: 3, blocks: [0x0E40, 0x4C40, 0x4E00, 0x4640], color: '#ff9a5a' };
var z = { size: 3, blocks: [0x0C60, 0x4C80, 0xC600, 0x2640], color: '#ff5d73' };
...
function drawNext() {
  if (invalid.next) {
    ...
    uctx.strokeStyle = 'rgba(255,255,255,.25)';
